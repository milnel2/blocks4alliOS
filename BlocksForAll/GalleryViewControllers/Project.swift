...
class Project : Equatable{
    ...
    var currentActor: VirtualRobot? = nil // For freeplay projects. Actor that is currently being edited. Physical robot projects will have one Virtual Robot by default
